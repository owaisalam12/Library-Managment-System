...
{
    public partial class ReportCountryWise_View_ : Form
    {
        public ReportCountryWise_View_()
        {
            InitializeComponent();
        }
        public string combQuery;
        private void ReportCountryWise_View__Load(object sender, EventArgs e)
        {
            ...
            SQLiteDataAdapter da = new SQLiteDataAdapter("SELECT * from querybook where Country='" + combQuery + "'", con);
