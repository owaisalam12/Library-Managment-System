...
{
    public partial class ReportAuthorWise_View_ : Form
    {
        public ReportAuthorWise_View_()
        {
            InitializeComponent();
        }
        public string combQuery;
        private void ReportAuthorWise_View__Load(object sender, EventArgs e)
        {
          ...
          // MessageBox.Show("" + rptAuth.authorwiseParameter);
            SQLiteDataAdapter da = new SQLiteDataAdapter("SELECT * from querybook where Author_Name='" + combQuery+"'", con);
