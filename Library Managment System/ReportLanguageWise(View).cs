...
{
    public partial class ReportLanguageWise_View_ : Form
    {
        public ReportLanguageWise_View_()
        {
            InitializeComponent();
        }
        public string combQuery;
        private void ReportLanguageWise_View__Load(object sender, EventArgs e)
        {
            ...
            SQLiteDataAdapter da = new SQLiteDataAdapter("SELECT * from querybook where language='" + combQuery + "'", con);
