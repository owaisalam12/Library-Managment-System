...
{
    public partial class ReportPublisherWise_View_ : Form
    {
        public ReportPublisherWise_View_()
        {
            InitializeComponent();
        }
        public string combQuery;
        private void ReportPublisherWise_View__Load(object sender, EventArgs e)
        {
            ...
            SQLiteDataAdapter da = new SQLiteDataAdapter("SELECT * from querybook where Publisher_Name='" + combQuery + "'", con);
