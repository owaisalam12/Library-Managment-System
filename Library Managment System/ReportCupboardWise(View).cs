...
{
    public partial class ReportCupboardWise_View_ : Form
    {
        public ReportCupboardWise_View_()
        {
            InitializeComponent();
        }
        public string combQuery;

        private void ReportCupboardWise_View__Load(object sender, EventArgs e)
        {
            ...
            SQLiteDataAdapter da = new SQLiteDataAdapter("SELECT * from querybook where Regid='" + combQuery + "'", con);
